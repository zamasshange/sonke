  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="flex-1 pt-20 sm:pt-24">
        <section className="relative overflow-hidden px-3 pb-12 pt-4 sm:px-4 sm:pb-20 sm:pt-6 lg:px-8 lg:pb-28">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="homepage-hero agency-grid overflow-hidden rounded-[1.35rem] p-4 sm:rounded-[2rem] sm:p-8 lg:p-10">
              <div className="grid gap-7 lg:grid-cols-[minmax(0,1.08fr)_440px] lg:items-stretch">
                <div className="flex flex-col justify-between gap-7 sm:gap-10">
                  <FadeInView>
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                      <Badge className="section-label border-0 px-3 py-2 sm:px-4">
                        South African remote income tools
                      </Badge>
                      <span className="rounded-full bg-white/70 px-3 py-2 text-xs font-medium text-muted-foreground sm:px-4 sm:text-sm">
                  ...
                  <FadeInView delay={0.08}>
                    <div className="max-w-3xl space-y-4 sm:space-y-6">
                      <h1 className="max-w-3xl text-balance font-display text-[2.65rem] font-semibold leading-[1.02] sm:text-6xl lg:text-[4.8rem]">
                  ...
                  <FadeInView delay={0.14}>
                    <div className="hero-actions-wrap flex flex-col gap-5">
                      <div className="grid gap-3 sm:flex sm:flex-row sm:gap-4">
                        <Button asChild size="lg" className="hero-button h-12 px-6 text-sm sm:h-14 sm:px-7 sm:text-base">
                          <Link href="/jobs">
                            Explore Jobs
                        ...
                        <Button
                          ...
                          size="lg"
                          variant="outline"
                          className="h-12 rounded-full border-border bg-transparent px-6 text-sm text-foreground hover:bg-foreground hover:text-background sm:h-14 sm:px-7 sm:text-base"
                        >
                  ...
                  <FadeInView delay={0.2}>
                    <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
                      <div className="soft-panel p-4 sm:p-5">
                        <p className="text-3xl font-semibold sm:text-4xl">{jobs.length}</p>
                        <p className="mt-2 text-xs uppercase tracking-[0.18em] text-muted-foreground sm:text-sm sm:tracking-[0.24em]">Live opportunities</p>
                      </div>
                      <div className="soft-panel p-4 sm:p-5">
                        <p className="text-3xl font-semibold sm:text-4xl">{guides.length}</p>
                        <p className="mt-2 text-xs uppercase tracking-[0.18em] text-muted-foreground sm:text-sm sm:tracking-[0.24em]">Detailed guides</p>
                      </div>
                      <div className="soft-panel p-4 sm:p-5">
                        <p className="text-3xl font-semibold sm:text-4xl">{paymentMethods.length}</p>
                        <p className="mt-2 text-xs uppercase tracking-[0.18em] text-muted-foreground sm:text-sm sm:tracking-[0.24em]">Payment rails</p>
                      </div>
                    </div>
                  </FadeInView>
                </div>
                    ...
                    <div className="hero-visual-card">
                      <div className="hero-visual-image-wrap">
                        ...
                        <div className="hero-visual-copy">
                          ...
                          <p className="mt-3 max-w-sm text-xl font-semibold text-white sm:text-2xl">
                      ...
                      <div className="hero-aside-footer">
                        <div className="hero-signal-panel dark-panel rounded-[1.25rem] p-4 sm:rounded-[1.5rem] sm:p-5">
                          <p className="text-xs uppercase tracking-[0.2em] text-white/55 sm:text-sm sm:tracking-[0.28em]">Current market signal</p>
                          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                            <div className="rounded-[1.15rem] bg-white/8 p-3 sm:p-4">
                        ...
                        <div className="soft-panel flex min-h-[12rem] flex-col justify-between p-4 sm:min-h-[14rem] sm:p-5">
            ...
            <FadeInView>
              <div className="grid gap-4 sm:grid-cols-[1fr_0.8fr]">
                <div className="overflow-hidden rounded-[2rem]">
                  <img src={showcaseImages[2]} alt="Person working from a laptop" className="h-full min-h-[18rem] w-full object-cover sm:min-h-[29rem]" />
                </div>
                <div className="grid gap-4">
                  <div className="soft-panel p-5 sm:p-6">
                    <p className="text-sm uppercase tracking-[0.24em] text-muted-foreground">Pathway</p>
                    <p className="mt-4 text-2xl font-semibold sm:text-3xl">Clear steps for choosing a path and taking action.</p>
                  </div>
                  <div className="dark-panel rounded-[1.5rem] p-5 sm:rounded-[1.75rem] sm:p-6">
              ...
              <div className="space-y-8">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="soft-panel p-5 sm:p-6">
                    ...
                    <p className="mt-5 text-xl font-semibold sm:text-2xl">Choose a path</p>
                  ...
                  <div className="soft-panel p-5 sm:p-6">
                    ...
                    <p className="mt-5 text-xl font-semibold sm:text-2xl">Plan the first week</p>
        ...
        <section className="bg-secondary/70 px-4 py-14 sm:py-20 lg:px-8 lg:py-28">
          <div className="mx-auto max-w-7xl">
            <FadeInView>
              ...
              {capabilityCards.map((card) => (
                <StaggerItem key={card.title}>
                  <article className="soft-panel overflow-hidden p-0">
                    <img src={card.image} alt={card.title} className="h-56 w-full object-cover sm:h-72" />
                    <div className="p-5 sm:p-6">
                      <p className="text-xl font-semibold sm:text-2xl">{card.title}</p>
            ...
            <StaggerContainer className="mt-12 grid gap-6 lg:grid-cols-3">
              {latestJobs.map((job, index) => (
                <StaggerItem key={job.id}>
                  <article className={`${index === 1 ? 'dark-panel text-white' : 'soft-panel'} h-full p-5 sm:p-6`}>
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className={`text-sm uppercase tracking-[0.24em] ${index === 1 ? 'text-white/60' : 'text-muted-foreground'}`}>{job.company}</p>
                        <h3 className="mt-3 text-2xl font-semibold leading-tight sm:text-3xl">{job.title}</h3>
                      </div>
                    ...
                    <div className={`mt-8 flex flex-col gap-4 border-t pt-5 sm:flex-row sm:items-center sm:justify-between ${index === 1 ? 'border-white/10' : 'border-border/60'}`}>
                      <div>
                      ...
                      <p className="font-semibold sm:text-right">{job.salary}</p>
                    </div>
                  </article>
                </StaggerItem>
              ))}
            ...
            <StaggerContainer className="mt-12 grid gap-6 lg:grid-cols-3">
              {featuredGuides.map((guide, index) => (
                <StaggerItem key={guide.slug}>
                  <article className={`${index === 0 ? 'dark-panel text-white' : 'soft-panel'} h-full p-5 sm:p-6`}>
                    <div className="flex items-center justify-between gap-4">
                    ...
                    <h3 className="mt-6 text-2xl font-semibold leading-tight sm:text-3xl">{guide.title}</h3>
        ...
        <section className="px-4 pb-16 pt-14 sm:pb-24 sm:pt-20 lg:px-8 lg:pb-32 lg:pt-28">
          <div className="mx-auto max-w-7xl">
            <FadeInView>
              <div className="dark-panel overflow-hidden rounded-[1.5rem] px-5 py-10 sm:rounded-[2.2rem] sm:px-10 lg:px-14 lg:py-16">
                <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                  <div className="space-y-6">
                    <Badge className="border border-white/12 bg-white/8 px-4 py-2 text-white">Ready to start</Badge>
                    <h2 className="max-w-2xl font-display text-3xl font-semibold leading-tight text-white sm:text-5xl">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-[1.25rem] bg-white/8 p-4 text-white sm:rounded-[1.5rem] sm:p-5">
                      <Calculator className="h-5 w-5 text-accent" />
                      <p className="mt-5 text-xl font-semibold sm:text-2xl">Estimate your target</p>
                    ...
                    <div className="rounded-[1.25rem] bg-white/8 p-4 text-white sm:rounded-[1.5rem] sm:p-5">
                      ...
                      <p className="mt-5 text-xl font-semibold sm:text-2xl">Set up payments</p>
